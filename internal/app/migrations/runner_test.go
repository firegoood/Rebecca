...
func TestRunMigrationsFreshSQLiteAndDoubleRun(t *testing.T) {
	...
	assertTableColumns(t, ctx, db, "sqlite", "services", []string{"id", "name", "description", "flow", "used_traffic", "lifetime_used_traffic", "users_usage", "subscription_placeholder_settings"})
	...
	assertTableColumns(t, ctx, db, "sqlite", "subscription_settings", []string{"subscription_profile_title", "subscription_support_url", "subscription_aliases", "subscription_path", "subscription_ports", "happ_subscription_template", "incy_subscription_template", "use_custom_json_for_incy", "subscription_placeholder_enabled", "subscription_placeholder_remark"})
