...
var file_rebecca_node_v1_node_proto_msgTypes = make([]protoimpl.MessageInfo, 51)
var file_rebecca_node_v1_node_proto_goTypes = []any{
	...
	(*TorProxyRequest)(nil),          // 30: rebecca.node.v1.TorProxyRequest
	(*WindscribeProxyRequest)(nil),   // 31: rebecca.node.v1.WindscribeProxyRequest
	(*WindscribeLocation)(nil),       // 32: rebecca.node.v1.WindscribeLocation
	(*WindscribeProxyResponse)(nil),  // 33: rebecca.node.v1.WindscribeProxyResponse
	(*PsiphonProxyRequest)(nil),      // 34: rebecca.node.v1.PsiphonProxyRequest
	(*PsiphonProxyInstance)(nil),     // 35: rebecca.node.v1.PsiphonProxyInstance
	(*PsiphonProxyResponse)(nil),     // 36: rebecca.node.v1.PsiphonProxyResponse
	(*SystemMetrics)(nil),            // 37: rebecca.node.v1.SystemMetrics
	(*TransferMetrics)(nil),          // 38: rebecca.node.v1.TransferMetrics
	(*CollectUsageRequest)(nil),      // 39: rebecca.node.v1.CollectUsageRequest
	(*UserUsageBatch)(nil),           // 40: rebecca.node.v1.UserUsageBatch
	(*UserUsageSample)(nil),          // 41: rebecca.node.v1.UserUsageSample
	(*OnlineUserIP)(nil),             // 42: rebecca.node.v1.OnlineUserIP
	(*OnlineIP)(nil),                 // 43: rebecca.node.v1.OnlineIP
	(*OutboundUsageBatch)(nil),       // 44: rebecca.node.v1.OutboundUsageBatch
	(*OutboundUsageSample)(nil),      // 45: rebecca.node.v1.OutboundUsageSample
	(*AckUsageRequest)(nil),          // 46: rebecca.node.v1.AckUsageRequest
	(*AckUsageResponse)(nil),         // 47: rebecca.node.v1.AckUsageResponse
	(*StreamLogsRequest)(nil),        // 48: rebecca.node.v1.StreamLogsRequest
	(*LogLine)(nil),                  // 49: rebecca.node.v1.LogLine
	nil,                              // 50: rebecca.node.v1.InboundUser.FieldsEntry
}
var file_rebecca_node_v1_node_proto_depIdxs = []int32{
	...
	50, // 6: rebecca.node.v1.InboundUser.fields:type_name -> rebecca.node.v1.InboundUser.FieldsEntry
	7,  // 7: rebecca.node.v1.MetricsResponse.runtime:type_name -> rebecca.node.v1.RuntimeState
	37, // 8: rebecca.node.v1.MetricsResponse.system:type_name -> rebecca.node.v1.SystemMetrics
	38, // 9: rebecca.node.v1.MetricsResponse.transfer:type_name -> rebecca.node.v1.TransferMetrics
	...
	7,  // 12: rebecca.node.v1.WindscribeProxyResponse.runtime:type_name -> rebecca.node.v1.RuntimeState
	32, // 13: rebecca.node.v1.WindscribeProxyResponse.locations:type_name -> rebecca.node.v1.WindscribeLocation
	7,  // 14: rebecca.node.v1.PsiphonProxyResponse.runtime:type_name -> rebecca.node.v1.RuntimeState
	35, // 15: rebecca.node.v1.PsiphonProxyResponse.instances:type_name -> rebecca.node.v1.PsiphonProxyInstance
	41, // 16: rebecca.node.v1.UserUsageBatch.stats:type_name -> rebecca.node.v1.UserUsageSample
	42, // 17: rebecca.node.v1.UserUsageBatch.online_ips:type_name -> rebecca.node.v1.OnlineUserIP
	43, // 18: rebecca.node.v1.OnlineUserIP.ips:type_name -> rebecca.node.v1.OnlineIP
	45, // 19: rebecca.node.v1.OutboundUsageBatch.stats:type_name -> rebecca.node.v1.OutboundUsageSample
	1,  // 20: rebecca.node.v1.NodeControlService.Hello:input_type -> rebecca.node.v1.HelloRequest
	3,  // 21: rebecca.node.v1.NodeControlService.Connect:input_type -> rebecca.node.v1.ConnectRequest
	5,  // 22: rebecca.node.v1.NodeControlService.Health:input_type -> rebecca.node.v1.HealthRequest
	8,  // 23: rebecca.node.v1.NodeRuntimeService.StartRuntime:input_type -> rebecca.node.v1.RuntimeConfigRequest
	8,  // 24: rebecca.node.v1.NodeRuntimeService.RestartRuntime:input_type -> rebecca.node.v1.RuntimeConfigRequest
	9,  // 25: rebecca.node.v1.NodeRuntimeService.StopRuntime:input_type -> rebecca.node.v1.StopRuntimeRequest
	8,  // 26: rebecca.node.v1.NodeRuntimeService.SyncConfig:input_type -> rebecca.node.v1.RuntimeConfigRequest
	11, // 27: rebecca.node.v1.NodeRuntimeService.AddUser:input_type -> rebecca.node.v1.InboundUserRequest
	11, // 28: rebecca.node.v1.NodeRuntimeService.UpdateUser:input_type -> rebecca.node.v1.InboundUserRequest
	12, // 29: rebecca.node.v1.NodeRuntimeService.RemoveUser:input_type -> rebecca.node.v1.RemoveInboundUserRequest
	14, // 30: rebecca.node.v1.NodeRuntimeService.Metrics:input_type -> rebecca.node.v1.MetricsRequest
	16, // 31: rebecca.node.v1.NodeRuntimeService.PublicIPs:input_type -> rebecca.node.v1.PublicIPsRequest
	18, // 32: rebecca.node.v1.NodeRuntimeService.TestOutbound:input_type -> rebecca.node.v1.OutboundTestRequest
	20, // 33: rebecca.node.v1.NodeRuntimeService.TestRoute:input_type -> rebecca.node.v1.RouteTestRequest
	22, // 34: rebecca.node.v1.NodeRuntimeService.UpdateRuntime:input_type -> rebecca.node.v1.RuntimeUpdateRequest
	23, // 35: rebecca.node.v1.NodeRuntimeService.UpdateGeo:input_type -> rebecca.node.v1.GeoUpdateRequest
	25, // 36: rebecca.node.v1.NodeRuntimeService.RestartService:input_type -> rebecca.node.v1.ServiceRestartRequest
	26, // 37: rebecca.node.v1.NodeRuntimeService.UpdateService:input_type -> rebecca.node.v1.ServiceUpdateRequest
	27, // 38: rebecca.node.v1.NodeRuntimeService.RebootHost:input_type -> rebecca.node.v1.HostRebootRequest
	28, // 39: rebecca.node.v1.NodeRuntimeService.ApplyIPBlocks:input_type -> rebecca.node.v1.IPBlockRequest
	30, // 40: rebecca.node.v1.NodeRuntimeService.ApplyTorProxy:input_type -> rebecca.node.v1.TorProxyRequest
	31, // 41: rebecca.node.v1.NodeRuntimeService.ConfigureWindscribe:input_type -> rebecca.node.v1.WindscribeProxyRequest
	34, // 42: rebecca.node.v1.NodeRuntimeService.ConfigurePsiphon:input_type -> rebecca.node.v1.PsiphonProxyRequest
	39, // 43: rebecca.node.v1.NodeUsageService.CollectUserUsage:input_type -> rebecca.node.v1.CollectUsageRequest
	46, // 44: rebecca.node.v1.NodeUsageService.AckUserUsage:input_type -> rebecca.node.v1.AckUsageRequest
	39, // 45: rebecca.node.v1.NodeUsageService.CollectOutboundUsage:input_type -> rebecca.node.v1.CollectUsageRequest
	46, // 46: rebecca.node.v1.NodeUsageService.AckOutboundUsage:input_type -> rebecca.node.v1.AckUsageRequest
	48, // 47: rebecca.node.v1.NodeLogsService.StreamLogs:input_type -> rebecca.node.v1.StreamLogsRequest
	2,  // 48: rebecca.node.v1.NodeControlService.Hello:output_type -> rebecca.node.v1.HelloResponse
	4,  // 49: rebecca.node.v1.NodeControlService.Connect:output_type -> rebecca.node.v1.ConnectResponse
	6,  // 50: rebecca.node.v1.NodeControlService.Health:output_type -> rebecca.node.v1.HealthResponse
	10, // 51: rebecca.node.v1.NodeRuntimeService.StartRuntime:output_type -> rebecca.node.v1.RuntimeActionResponse
	10, // 52: rebecca.node.v1.NodeRuntimeService.RestartRuntime:output_type -> rebecca.node.v1.RuntimeActionResponse
	10, // 53: rebecca.node.v1.NodeRuntimeService.StopRuntime:output_type -> rebecca.node.v1.RuntimeActionResponse
	10, // 54: rebecca.node.v1.NodeRuntimeService.SyncConfig:output_type -> rebecca.node.v1.RuntimeActionResponse
	10, // 55: rebecca.node.v1.NodeRuntimeService.AddUser:output_type -> rebecca.node.v1.RuntimeActionResponse
	10, // 56: rebecca.node.v1.NodeRuntimeService.UpdateUser:output_type -> rebecca.node.v1.RuntimeActionResponse
	10, // 57: rebecca.node.v1.NodeRuntimeService.RemoveUser:output_type -> rebecca.node.v1.RuntimeActionResponse
	15, // 58: rebecca.node.v1.NodeRuntimeService.Metrics:output_type -> rebecca.node.v1.MetricsResponse
	17, // 59: rebecca.node.v1.NodeRuntimeService.PublicIPs:output_type -> rebecca.node.v1.PublicIPsResponse
	19, // 60: rebecca.node.v1.NodeRuntimeService.TestOutbound:output_type -> rebecca.node.v1.OutboundTestResponse
	21, // 61: rebecca.node.v1.NodeRuntimeService.TestRoute:output_type -> rebecca.node.v1.RouteTestResponse
	10, // 62: rebecca.node.v1.NodeRuntimeService.UpdateRuntime:output_type -> rebecca.node.v1.RuntimeActionResponse
	10, // 63: rebecca.node.v1.NodeRuntimeService.UpdateGeo:output_type -> rebecca.node.v1.RuntimeActionResponse
	10, // 64: rebecca.node.v1.NodeRuntimeService.RestartService:output_type -> rebecca.node.v1.RuntimeActionResponse
	10, // 65: rebecca.node.v1.NodeRuntimeService.UpdateService:output_type -> rebecca.node.v1.RuntimeActionResponse
	10, // 66: rebecca.node.v1.NodeRuntimeService.RebootHost:output_type -> rebecca.node.v1.RuntimeActionResponse
	10, // 67: rebecca.node.v1.NodeRuntimeService.ApplyIPBlocks:output_type -> rebecca.node.v1.RuntimeActionResponse
	10, // 68: rebecca.node.v1.NodeRuntimeService.ApplyTorProxy:output_type -> rebecca.node.v1.RuntimeActionResponse
	33, // 69: rebecca.node.v1.NodeRuntimeService.ConfigureWindscribe:output_type -> rebecca.node.v1.WindscribeProxyResponse
	36, // 70: rebecca.node.v1.NodeRuntimeService.ConfigurePsiphon:output_type -> rebecca.node.v1.PsiphonProxyResponse
	40, // 71: rebecca.node.v1.NodeUsageService.CollectUserUsage:output_type -> rebecca.node.v1.UserUsageBatch
	47, // 72: rebecca.node.v1.NodeUsageService.AckUserUsage:output_type -> rebecca.node.v1.AckUsageResponse
	44, // 73: rebecca.node.v1.NodeUsageService.CollectOutboundUsage:output_type -> rebecca.node.v1.OutboundUsageBatch
	47, // 74: rebecca.node.v1.NodeUsageService.AckOutboundUsage:output_type -> rebecca.node.v1.AckUsageResponse
	49, // 75: rebecca.node.v1.NodeLogsService.StreamLogs:output_type -> rebecca.node.v1.LogLine
