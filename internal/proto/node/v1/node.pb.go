...
type RuntimeState struct {
	...
	ProtocolStatuses []*ProtocolStatus      `protobuf:"bytes,10,rep,name=protocol_statuses,json=protocolStatuses,proto3" json:"protocol_statuses,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *RuntimeState) GetProtocolStatuses() []*ProtocolStatus {
	if x != nil {
		return x.ProtocolStatuses
	}
	return nil
}
...
type MetricsResponse struct {
	...
	Xray          *XrayMetrics           `protobuf:"bytes,5,opt,name=xray,proto3" json:"xray,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *MetricsResponse) GetXray() *XrayMetrics {
	if x != nil {
		return x.Xray
	}
	return nil
...
type ProtocolStatus struct {
	...
	Inbounds      uint32                 `protobuf:"varint,4,opt,name=inbounds,proto3" json:"inbounds,omitempty"`
...
func (x *ProtocolStatus) Reset() {
	*x = ProtocolStatus{}
	mi := &file_rebecca_node_v1_node_proto_msgTypes[54]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ProtocolStatus) Descriptor() ([]byte, []int) {
	return file_rebecca_node_v1_node_proto_rawDescGZIP(), []int{54}
}

func (x *ProtocolStatus) GetProtocol() string {
	if x != nil {
		return x.Protocol
	}
	return ""
...
func (x *ProtocolStatus) GetState() string {
	if x != nil {
		return x.State
	}
	return ""
...
func (x *ProtocolStatus) GetDetail() string {
	if x != nil {
		return x.Detail
	}
	return ""
...
func (x *ProtocolStatus) GetInbounds() uint32 {
	if x != nil {
		return x.Inbounds
	}
	return 0
...
func (x *ProtocolStatus) GetVersion() string {
	if x != nil {
		return x.Version
	}
	return ""
...
func (x *XrayMetrics) Reset() {
	*x = XrayMetrics{}
	mi := &file_rebecca_node_v1_node_proto_msgTypes[55]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *XrayMetrics) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*XrayMetrics) ProtoMessage() {}

func (x *XrayMetrics) ProtoReflect() protoreflect.Message {
	mi := &file_rebecca_node_v1_node_proto_msgTypes[55]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use XrayMetrics.ProtoReflect.Descriptor instead.
func (*XrayMetrics) Descriptor() ([]byte, []int) {
	return file_rebecca_node_v1_node_proto_rawDescGZIP(), []int{55}
}

func (x *XrayMetrics) GetPid() int32 {
	if x != nil {
		return x.Pid
	}
	return 0
...
func (x *XrayMetrics) GetCpuUsagePercent() float64 {
	if x != nil {
		return x.CpuUsagePercent
	}
	return 0
...
func (x *XrayMetrics) GetMemoryUsed() uint64 {
	if x != nil {
		return x.MemoryUsed
	}
	return 0
...
func (x *XrayMetrics) GetUptimeSeconds() uint64 {
	if x != nil {
		return x.UptimeSeconds
	}
	return 0
...
const file_rebecca_node_v1_node_proto_rawDesc = "" +
	...
	"\x04uids\x18\x01 \x03(\tR\x04uids\"\x90\x01\n" +
	"\x0eProtocolStatus\x12\x1a\n" +
	...
	"\binbounds\x18\x04 \x01(\rR\binbounds\x12\x18\n" +
	"\aversion\x18\x05 \x01(\tR\aversion\"\x93\x01\n" +
	"\vXrayMetrics\x12\x10\n" +
...
var file_rebecca_node_v1_node_proto_msgTypes = make([]protoimpl.MessageInfo, 57)
